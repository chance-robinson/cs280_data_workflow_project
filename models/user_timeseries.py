...
class User_Timeseries(Base):
    ...
    def __repr__(self) -> str:
        return f"User_Timeseries(id={self.id}, user_id={self.user_id}, followers_count={self.followers_count}, following_count={self.followers_count}, tweet_count={self.tweet_count}, listed_count={self.listed_count}, date={self.date})"